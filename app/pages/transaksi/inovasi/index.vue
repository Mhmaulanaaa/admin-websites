...
import BaseModalTransaksiInovasi from "~/components/base/transaksi/BaseModalTransaksiInovasi.vue";

useHead({
  title: "Admin Transaksi Inovasi",
});
definePageMeta({
  breadcrumb: [{ label: "Transaksi", to: "/transaksi" }, { label: "Inovasi" }],
});
...
const dataTable = ref([
  {
    kode_inovasi: "INV20260429001",
    judul: "Judul Inovasi 1",
    deskripsi: "Deskripsi inovasi 1",
    tanggal: "2022-12-30",
    file: "https://example.com/file1.jpg",
    status: "aktif",
  },
  {
    kode_inovasi: "INV20260429002",
    judul: "Judul Inovasi 2",
    deskripsi: "Deskripsi inovasi 2",
    tanggal: "2024-03-05",
    file: "https://example.com/file1.jpg",
    status: "tidak_aktif",
  },
...
const kodeOptions = computed(() =>
  dataTable.value.map((i) => ({
    label: `${i.kode_inovasi} - ${i.judul}`,
    value: i.kode_inovasi,
  }))
);
...
const filteredData = computed(() => {
  return dataTable.value.filter((item) => {
    const matchKode =
      !appliedFilter.value.kode || item.kode_inovasi === appliedFilter.value.kode;
...
const columns = [
  ...
  { accessorKey: "kode_inovasi", header: "Kode Inovasi" },
...
<template>
  ...
  <div class="grid grid-cols-3 gap-4 mb-6">
    ...
    <BaseStatCard
      title="Total Inovasi Tidak Aktif"
  ...
  >
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
      ...
      <div class="w-full group flex items-center sm:w-full group gap-5">
        <div class="flex-1">
          <USelectMenu
            label="Pilih Nomor dan Nama Inovasi"
            placeholder="Pilih Nomor dan Nama Inovasi"
            v-model="kodeFilter"
            :items="kodeOptions"
            value-key="value"
            label-key="label"
