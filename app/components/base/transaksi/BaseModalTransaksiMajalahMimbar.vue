...
function generateKode() {
  ...
  form.kode_majalah = `SJT${tanggal}${urutan}`;
}
...
watch(
  ...
  (val) => {
    ...
    if (props.isEdit && props.initialData) {
      ...
      form.kode_majalah = initialData.kode_majalah;
    ...
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-sm font-semibold text-slate-800 dark:text-white">
                {{ isEdit ? "Edit Majalah Mimbar" : "Tambah Majalah Mimbar" }}
              </h2>
              <p class="text-xs text-slate-500">
                {{
                  isEdit
                    ? "Perbarui data majalah mimbar"
                    : "Tambahkan majalah mimbar baru"
                }}
              </p>
            </div>
          </div>
        ...
        <div class="p-6 m-1 gap-2">
          <div v-if="isEdit">
            <label class="text-sm">Kode Majalah Mimbar</label>
            <BaseInput
              v-model="form.kode_majalah"
              placeholder="Kode Majalah Mimbar"
              disabled
            />
          </div>
          <div>
