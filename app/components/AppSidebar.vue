...
const menus: Menu[] = [
  { name: "Beranda", icon: "heroicons:home", to: "/dashboard" },
  {
    name: "Master",
    ...
    children: [
      ...
      },
      {
        name: "Master Menu",
        icon: "heroicons:chevron-right",
        to: "/master/mastermenu",
      },
      {
        name: "Master Submenu",
        icon: "heroicons:chevron-right",
        to: "/master/mastersubmenu",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: "PPID - Layanan Informasi",
        icon: "heroicons:chevron-right",
        to: "/layanan-unggulan",
      },
      {
        name: "Pengaduan - Dokumen",
        icon: "heroicons:chevron-right",
        to: "/layanan-unggulan",
      },
      {
        name: "Pengaduan - Rekapitulasi",
        icon: "heroicons:chevron-right",
        to: "/layanan-unggulan",
      },
      {
